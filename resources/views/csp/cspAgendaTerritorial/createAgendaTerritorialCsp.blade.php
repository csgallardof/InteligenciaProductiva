							...
							<div class="height-lg" data-scrollbar="true">
									  	...
									  	<div class="form-group">
                                   		 ...
                                   		 <label for="fecha_agenda">Fecha de Agenda</label>
		                                        ...
		                                        <div class="input-group date" id="datepicker-disabled-past" data-date-format="dd-mm-yyyy" data-date-start-date="Date.default">
		                                            <input type="text" readonly name="fecha_agenda" class="form-control" placeholder="Seleccione Fecha" />
		                                      	...
		                                      	<div class="col-md-3">
														...
														<div class="col-md-8">
															<div class="input-group bootstrap-timepicker">
																<input id="timepicker" type="text" name="hora_agenda" class="form-control" />
								...
								<div class="form-group">
									...
									<label for="select-provincia">Lugar: <br> <br> Provincia</label>
									    ...
									    <select id="select-provincia" onchange="getSelectValue();" name="select-provincia" class="form-control selectpicker" data-size="10" data-live-search="true" data-style="btn-primary">
								...
								<div class="form-group">
									...
									<label for="tipo_agenda_id">Tipo Agenda</label>
									    ...
									    <select class="form-control selectpicker" data-size="10" data-live-search="true" name="tipo_agenda_id" data-style="btn-info">
								...
								<div class="form-group ">
									 		...
									 		<div class="row">
									 			...
									 			<div class="col-md-3"></div>
									 			<div class="col-md-6">
									 			<textarea class="form-control" id="lineas_discursivas" name="descripcion_tipo_agenda" rows="3" onKeyDown="cuenta()" onKeyUp="cuenta()"></textarea>
									 			</div>
								...
								<div class="form-group">
									...
									<label for="tipo_impacto_id"><br><br>Tipo Impacto</label>
									    ...
									    <select class="form-control selectpicker" data-size="10" data-live-search="true" name="tipo_impacto_id" data-style="btn-info">
                                            <option value="" selected>Seleccione una Opcion</option>
								...
								<div class="form-group">
									 		...
									 		<div class="row">
									 			...
									 			<div class="col-md-3"></div>
									 			<div class="col-md-6">
									 			<textarea required class="form-control" id="descripcion_tipo_impacto" name="descripcion_tipo_impacto" rows="3" onKeyDown="cuenta()" onKeyUp="cuenta()"></textarea>	
									 			</div>
