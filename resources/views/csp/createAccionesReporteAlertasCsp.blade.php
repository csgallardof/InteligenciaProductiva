				...
				<div class="col-md-12">
					...
					<div class="panel panel-inverse" data-sortable-id="index-5">
						<div class="panel-heading">
							...
							<h4 class="panel-title"><i class="fa fa-file-text-o" aria-hidden="true"></i> Nueva Accion Reporte {{$cspReportesAlerta->tema}} CSP</h4>
						</div>
										...
										{{ csrf_field() }}
									 	...
									 	<div class="form-group">
									 		...
									 		<div class="row">
									 			...
									 			<div class="col-md-3"> </div>
									 			<div class="col-md-6">
									 			<textarea  required class="form-control" id="acciones" name="acciones" rows="3" onKeyDown="cuenta()" onKeyUp="cuenta()"></textarea>
									 			</div>	
