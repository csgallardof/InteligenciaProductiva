                ...
                <div class="col-md-12">
                    ...
                    <div class="panel panel-inverse" data-sortable-id="index-5">
                        <div class="panel-heading">
                            ...
                            <h4 class="panel-title"><i class="fa fa-file-text-o" aria-hidden="true"></i> Actualizar Reporte Hecho CSP</h4>
                        </div>
                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="col-md-4">
                                                        <select class="form-control" required="" name="tipo_comunicacional" id="">
                                                            ...
                                                            <option value="Institucional" {{ ( $cspReportesHecho->tipo_comunicacional == 'Institucional' ) ? 'selected' : '' }} >Institucional</option>
                                                            <option value="Presidencia"{{ ( $cspReportesHecho->tipo_comunicacional == 'Presidencia' ) ? 'selected' : '' }}>Presidencia</option>
                                                            <option value="Institucional y Presidencia"{{ ( $cspReportesHecho->tipo_comunicacional == 'Institucional y Presidencia' ) ? 'selected' : '' }}>Institucional y Presidencia</option>
                                                        </select>
                                                    </div>
                                                </div>
