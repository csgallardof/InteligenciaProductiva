...
<ul class="media-list media-list-with-divider">
    <li class="media media-lg">
        <a href="javascript:;" class="pull-left">
            <img class="media-object" src="{{ asset('imagenes/cifras/graficos_provincia/06.Chimborazo/06_01.png') }}" alt="" />
        </a>
    ...
    <li class="media media-lg">
        <a href="javascript:;" class="pull-left">
            <img class="media-object" src="{{ asset('imagenes/cifras/graficos_provincia/06.Chimborazo/06_02.png') }}" alt="" />
        </a>
    ...
    <li class="media media-lg">
        <a href="javascript:;" class="pull-left">
            <img class="media-object" src="{{ asset('imagenes/cifras/graficos_provincia/06.Chimborazo/06_03.png') }}" alt="" />
        </a>
    ...
    <li class="media media-lg">
        <a href="javascript:;" class="pull-left">
            <img class="media-object" src="{{ asset('imagenes/cifras/graficos_provincia/06.Chimborazo/06_04.png') }}" alt="" />
        </a>
    ...
    <li class="media media-lg">
        <a href="javascript:;" class="pull-left">
            <img class="media-object" src="{{ asset('imagenes/cifras/graficos_provincia/06.Chimborazo/06_05.png') }}" alt="" />
        </a>
        
        <div class="media-body">
            <h5 class="media-heading"><strong>Gráfico 5:</strong><br><strong>Gráfico 5:</strong><br>Evolución del subempleo. (Tasas)</h5>
            <h7><strong>Fuente:</strong>Instituto Nacional de Estadística y Censos-ENEMDU</h7>
        </div>
    </li>
    <li class="media media-lg">
        <a href="javascript:;" class="pull-left">
            <img class="media-object" src="{{ asset('imagenes/cifras/graficos_provincia/06.Chimborazo/06_06.png') }}" alt="" />
        </a>
    ...
    <li class="media media-lg">
        <a href="javascript:;" class="pull-left">
            <img class="media-object" src="{{ asset('imagenes/cifras/graficos_provincia/06.Chimborazo/06_07.png') }}" alt="" />
        </a>
    ...
    <li class="media media-lg">
        <a href="javascript:;" class="pull-left">
            <img class="media-object" src="{{ asset('imagenes/cifras/graficos_provincia/06.Chimborazo/06_08.png') }}" alt="" />
        </a>
    ...
    <li class="media media-lg">
        <a href="javascript:;" class="pull-left">
            <img class="media-object" src="{{ asset('imagenes/cifras/graficos_provincia/06.Chimborazo/06_09.png') }}" alt="" />
        </a>
    ...
    <li class="media media-lg">
        <a href="javascript:;" class="pull-left">
            <img class="media-object" src="{{ asset('imagenes/cifras/graficos_provincia/06.Chimborazo/06_10.png') }}" alt="" />
        </a>
    ...
    <li class="media media-lg">
        <a href="javascript:;" class="pull-left">
            <img class="media-object" src="{{ asset('imagenes/cifras/graficos_provincia/06.Chimborazo/06_11.png') }}" alt="" />
        </a>
    ...
    <li class="media media-lg">
        <a href="javascript:;" class="pull-left">
            <img class="media-object" src="{{ asset('imagenes/cifras/graficos_provincia/06.Chimborazo/06_12.png') }}" alt="" />
        </a>
    ...
    <li class="media media-lg">
        <a href="javascript:;" class="pull-left">
            <img class="media-object" src="{{ asset('imagenes/cifras/graficos_provincia/06.Chimborazo/06_13.png') }}" alt="" />
        </a>
    ...
    <li class="media media-lg">
        <a href="javascript:;" class="pull-left">
            <img class="media-object" src="{{ asset('imagenes/cifras/graficos_provincia/06.Chimborazo/06_14.png') }}" alt="" />
        </a>
    ...
    <li class="media media-lg">
        <a href="javascript:;" class="pull-left">
            <img class="media-object" src="{{ asset('imagenes/cifras/graficos_provincia/06.Chimborazo/06_15.png') }}" alt="" />
        </a>
    ...
    <li class="media media-lg">
        <a href="javascript:;" class="pull-left">
            <img class="media-object" src="{{ asset('imagenes/cifras/graficos_provincia/06.Chimborazo/06_16.png') }}" alt="" />
        </a>
    ...
    <li class="media media-lg">
        <a href="javascript:;" class="pull-left">
            <img class="media-object" src="{{ asset('imagenes/cifras/graficos_provincia/06.Chimborazo/06_17.png') }}" alt="" />
        </a>
