    ...
    <div class="content row main-content">
          ...
          <div class="menu-lateral-general form-group menuVertical">
            ...
            <div class="input-group" style="padding-right: 10px;padding-bottom: 10px">
              ...
              <ul class="nav menu-contenido-varios" >
                 <li class="has-sub"><a href="#insentivosgenerales" class="titulo">1. Incentivos Generales </a> </li>
                 <ul class="sub-menu">
                      <li><a href="#impuetoalarenta" class="subtitulo">Impuesto a la renta</a></li>
                 </ul>
                 <li class="has-sub"><a href="#insentivossectoriales" class="titulo">2. Incentivos Sectoriales</a> </li>
              </ul>
      ...
      <div id="zedes" class="col-sm-9 col-xs-12 p-l-0 p-r-30">
        ...
        <div class="site-page-content" >
            ...
            <h1 id="insentivosgenerales">Insentivos Tributarios y Arancelarios</h1><hr>

            <h3 id="insentivosgenerales">Insentivos Generales</h3><hr>          
            ...
            <h3 id="insentivossectoriales">Insentivos Sectoriales</h3><hr>
