    ...
    <div class="content row main-content header-fix-mobile">
            ...
            <div class="input-group" style="padding-right: 10px;padding-bottom: 10px">
               ...
               <ul class="nav menu-contenido-varios">
                   ...
                   <li class="has-sub"><a href="#combustibles" class="titulo">9. Combustibles</a>
                            <ul class="sub-menu">
                              <li ><a href="#sectorIndustrial" class="subtitulo">9.1. Sector Industrial (Agosto 2018)</a></li>
                              <li ><a href="#transCargaPesadaInternacional" class="subtitulo">9.2. Trans Carga Pesada Internacional (Agosto 2018)</a></li>
                              <li ><a href="#sectorusoparticular" class="subtitulo">9.3. Sector Uso Particular y Pesca DEP (Agosto 2018)</a></li>
                            </ul>
                  </li>
      ...
      <div id="costosindustriales" class="col-sm-9 col-xs-12 p-l-0 p-r-40">
            ...
            <div class="panel-titulo-custom-page" >
                <div class="btn-group pull-right">
                  <a href="{{ asset('archivos/costos_de_produccion_en_el_ecuador_agosto_2018.xlsx') }}" class="btn btn-primary btn-sm">Descargar</a>
                </div>
                <h1 id="costosparaelsectorindustrial">Costos para el Sector Industrial en el Ecuador  - Agosto 2018</h1>
            </div>
                ...
                <div class="panel custom-constos-panel-properties panel-inverse">
                    ...
                    <div class="panel-body panel-general-tabla-basica">
                      <table class="tablasgenerales table table-striped table-bordered">
                        <thead><th></th><th>Unidad de medida</th><th>31 agosto 2018*</th></thead>
                        <tbody>
              ...
              <div class="panel custom-constos-panel-properties panel-inverse">
                  ...
                  <div class="panel-body panel-general-tabla-basica">
                    <table class="tablasgenerales table table-striped table-bordered">
                      ...
                      <thead><th></th><th>Unidad de medida</th>
                        <th>31 julio 2018*</th>
                        <th>31 agosto 2018*</th>
                        <th>Variación</th></thead>
                      <tbody>
                        <tr>
                          <td>Petróleo</td>
                          <td>Barril</td>
                          <td>70.60</td>
                          <td>69.80</td>
                          <td><span class="arrow-color-rojo"><i class="fa fa-arrow-down"></i></span>-1,1%</td>
                        </tr>
                        <tr>
                          <td>Oro</td>
                          <td>Onza</td>
                          <td>1233.60</td>
                          <td>1206.70</td>
                          <td><span class="arrow-color-rojo"><i class="fa fa-arrow-down"></i></span>-2,2%</td></tr>
                        <tr>
                          <td>Plata</td>
                          <td>Onza</td>
                          <td>15.56</td>
                          <td>14.56</td>
                          <td><span class="arrow-color-rojo"><i class="fa fa-arrow-down"></i></span>-6,4%</td>
                        </tr>
                        <tr>
                          <td>Cobre</td>
                          <td>Libra</td>
                          <td>283.15</td>
                          <td>267.10</td>
                          <td><span class="arrow-color-rojo"><i class="fa fa-arrow-down"></i></span>-5,7%</td>
                        </tr>
                        <tr>
                          <td>Maíz</td>
                          <td>Tonelada</td>
                        ...
                        <tr>
                          ...
                          <td>6.20</td>
                          <td>6.20</td>
                          <td><span class="arrow-color-amarillo"><i class="fa fa-arrow-right"></i></span>0.0%</td>
                        </tr>
                        <tr>
                          <td>Trigo</td>
                          <td>Tonelada</td>
                          <td>553.75</td>
                          <td>514.00</td>
                          <td><span class="arrow-color-rojo"><i class="fa fa-arrow-down"></i></span>-7,2%</td>
                        </tr>
                        <tr>
                          <td>Cacao</td>
                          <td>Tonelada</td>
                          <td>2220.00</td>
                          <td>2282.00</td>
                          <td><span class="arrow-color-verde"><i class="fa fa-arrow-up"></i></span>2,8%</td>
                        </tr>
                      </tbody>
                    </table>
                  ...
                  <div class="panel-footer text-right">
                    <div class="h5" style="text-align: justify;">
                      <div><span><strong>Fuente:&nbsp;</strong></span>BCE, Bloomberg</div>
                      <div><em>*Expresado en USD</em></div>
                    </div>
                  </div>
              </div>
                ...
                <div class="panel-body panel-general-tabla-basica">
                  <table class="tablasgenerales table table-striped table-bordered">
                    ...
                    <thead><th></th><th>IPC</th><th>Variación mensual*</th><th>Variación anual*</th></tr></thead><tbody>
                     ...
                     <tr><td>Jul-17</td><td>105.40</td><td><span class="arrow-color-rojo"><i class="fa fa-arrow-down"></i></span>-0.1</td><td><span class="arrow-color-verde"><i class="fa fa-arrow-up"></i></span>0.1</td></tr>
                     ...
                     <tr><td>Jul-18</td><td>104.80</td><td><span class="arrow-color-rojo"><i class="fa fa-arrow-down"></i></span>-0.004</td><td><span class="arrow-color-rojo"><i class="fa fa-arrow-down"></i></span>-0.57</td></tr>
                     <tr><td>Agos-18</td><td>105.08</td><td><span class="arrow-color-verde"><i class="fa fa-arrow-up"></i></span>0.3</td><td><span class="arrow-color-rojo"><i class="fa fa-arrow-down"></i></span>-0.32</td></tr>
                    </tbody>
            ...
            <div class="panel custom-constos-panel-properties panel-inverse">
                ...
                <div class="panel-body panel-general-tabla-basica">
                  <table class="tablasgenerales table table-striped table-bordered">
                    ...
                    <thead><th></th><th>IPCO</th><th>Variación mensual*</th><th>Variación anual*</th></tr></thead>
                    <tbody>
                     ...
                     <tr><td>Jun-17</td><td>232.69</td><td><span class="arrow-color-rojo"><i class="fa fa-arrow-down"></i></span>-1.0</td><td><span class="arrow-color-rojo"><i class="fa fa-arrow-down"></i></span>-1.7</td></tr>
                      <tr><td>Jul-17</td><td>232.50</td><td><span class="arrow-color-rojo"><i class="fa fa-arrow-down"></i></span>-0.1</td><td><span class="arrow-color-rojo"><i class="fa fa-arrow-down"></i></span>-1.7</td></tr>
                     <tr><td>Jan-18</td><td>236.02</td><td><span class="arrow-color-verde"><i class="fa fa-arrow-up"></i></span>1.4</td><td><span class="arrow-color-verde"><i class="fa fa-arrow-up"></i></span>0.4</td></tr>
                     ...
                     <tr><td>Jun-18</td><td>236.79</td><td><span class="arrow-color-verde"><i class="fa fa-arrow-up"></i></span>0.2</td><td><span class="arrow-color-verde"><i class="fa fa-arrow-up"></i></span>2.0</td></tr>
                     <tr><td>Jul-18**</td><td>237.73</td><td><span class="arrow-color-verde"><i class="fa fa-arrow-up"></i></span>0.2</td><td><span class="arrow-color-verde"><i class="fa fa-arrow-up"></i></span>2.2</td></tr>
                    </tbody>
      ...
      <div class="row">
        ...
        <div class="panel-custom-tables-1 col-md-6 col-xs-12" align="center">
          <div class="panel custom-constos-panel-properties panel-inverse">
              <div class="panel-heading">
                  <h4 class="panel-title" id="sectorIndustrial">SECTOR INDUSTRIAL (Septiembre 2018)</h4>
              </div>
              <div class="panel-body panel-general-tabla-basica">
                <table class="tablasgenerales table table-striped table-bordered">
                  ...
                  <tbody>
                   <tr><td>Diésel 1 Industrial</td><td>Galones</td><td>2.26 </td></tr>
                   <tr><td>Diésel 2  Industrial</td><td>Galones</td><td>2.26 </td></tr>
                   <tr><td>Diésel Premium Industrial</td><td>Galones</td><td>2.40 </td></tr>
                   <tr><td>Extra Industrial</td><td>Galones</td><td>2.39 </td></tr>
                   <tr><td>Extra Con Etanol Industrial</td><td>Galones</td><td>2.39 </td></tr>
                   <tr><td>Súper Industrial</td><td>Galones</td><td>2.48 </td></tr>
                   <tr><td>Fuel Oil No. 6 Industrial</td><td>Galones</td><td>1.20 </td></tr>
                   <tr><td>Fuel Oil Liviano</td><td>Galones</td><td>1.08 </td></tr>
                   <tr><td>Gas  (Glp) Industrial</td><td>Kilogramos</td><td>0.89 </td></tr>
                   <tr><td>Residuo Cementero</td><td>Galones</td><td>0.97 </td></tr>
                   <tr><td>Residuo Industrial</td><td>Galones</td><td>0.97 </td></tr>
                  </tbody>
        ...
        <div class="panel-custom-tables-1 col-md-6 col-xs-12" align="center">
          <div class="panel custom-constos-panel-properties panel-inverse">
              <div class="panel-heading">
                  <h4 class="panel-title" id="transCargaPesadaInternacional">TRANS.CARGA PESADA INTERNACIONAL (Septiembre 2018)</h4>
              </div>
              <div class="panel-body panel-general-tabla-basica">
                <table class="tablasgenerales table table-striped table-bordered">
                  ...
                  <thead><tr class=""><th>Producto</th><th>Unidad </th><th>Precio*</th></tr></thead>
                  <tbody>
                   <tr><td>Diésel carga internacional</td><td>Galones</td><td>3.96</td></tr>
                  </tbody>

                </table>
              </div>
              <div class="panel-heading">
                  <h4 id="sectorusoparticular" class="panel-title">SECTOR USO PARTICULAR Y PESCA DEP. (Septiembre 2018)</h4>
              </div>
              <div class="panel-body panel-general-tabla-basica">
                <table class="tablasgenerales table table-striped table-bordered">
                  ...
                  <tbody>
                   ...
                   <tr><td>Gasolina Súper Automotriz</td><td>Galones</td><td>2.47</td></tr>
                   <tr><td>Asfalto Indust. No Obra Pub.</td><td>Kilogramos</td><td>0.39</td></tr>
         ...
         <div class="panel custom-constos-panel-properties panel-inverse">
             ...
             <div class="panel-body panel-general-tabla-basica">
               <table class="big-tablasgenerales tablasgenerales table">
                 ...
                 <tbody>
                    <tr><td>Costo Promedio</td><td></td><td></td><td>4.073</td><td>0.075</td><td>2.670</td><td>3.979</td><td>0.074</td><td class="text-center" style="vertical-align: middle;" rowspan="14">CONSUMOS kWh-mes:<br />0-300: 1,414<br />301-500: 2,826<br />501-1000: 4,240<br />> 1000: 7,066</td></tr>
        ...
        <div class="panel custom-constos-panel-properties panel-inverse">
            ...
            <div class="panel-body panel-general-tabla-basica">
              <table class="big-tablasgenerales tablasgenerales table">
                ...
                <tbody>
                   <tr><td>Costo promedio</td><td></td><td></td><td>2.789</td><td>0.466</td><td>1.040</td><td>4.004</td><td>0.086</td><td class="text-center" style="vertical-align: middle;" rowspan="10"></tr>
       ...
       <div class="panel custom-constos-panel-properties panel-inverse">
           ...
           <div class="panel-body panel-general-tabla-basica">
             <table class="big-tablasgenerales tablasgenerales table">
               ...
               <tbody>
                 <tr><td>Costo promedio</td><td></td><td></td><td>0.185</td><td>1.414</td><td>0.185</td></tr>
