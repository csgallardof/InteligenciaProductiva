...
(select comentario from actividades where actividades.solucion_id = solucions.id order by created_at desc limit 1) as actividad,
...
and actividades.updated_at between '2018-04-01 00:00:00.000' and '2018-11-20 00:00:00.000';